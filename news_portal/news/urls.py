...
from .views import PostsList, SearchList, PostDetailView, PostCreateView, PostUpdateView, PostDeleteView, CategorySubscribeView, subscribe_category
# PostDetail,
...
# urlpatterns = [
#     path('category/', CategorySubscribe.as_view(), name='post_category'),
#     path('category/<int:pk>', subscribe_category, name='subscribe_category'),
